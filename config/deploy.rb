...
role :web, "desktop"                          # Your HTTP server, Apache/etc
role :app, "desktop"                          # This may be the same as your `Web` server
role :db,  "desktop", :primary => true        # This is where Rails migrations will run
